    ...
    await axios.get('https://htc2020-timecard.herokuapp.com/managergettasks/')
        .then(response => {
          ...
          for (const assign of response.data){
            tempList.push(<Assignments userid={this.props.location.state.userid} description={assign.description}id={assign._id} jobCode={assign.jobCode} activityCode={assign.activityCode} managerAssigned={managerDummy} />)
          }
